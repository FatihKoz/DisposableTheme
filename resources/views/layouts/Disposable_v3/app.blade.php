...
<html lang="en">
  <head>
    ...
    <link href="https://cdn.jsdelivr.net/npm/bootstrap@5.3.3/dist/css/bootstrap.min.css" rel="stylesheet" integrity="sha384-QWTKZyjpPEjISv5UEgmacK8SfF1V5VnC5pG1k6z4hNk0aQqY8x0k9x0k9x0" crossorigin="anonymous">
  ...
  @endif
    ...
    {{-- UTC Clock --}}
      ...
      @endif
    {{-- End of the UTC Clock code --}}
    {{-- Bootstrap Scripts v5.3.3 CDN --}}
    <script src="https://cdn.jsdelivr.net/npm/bootstrap@5.3.3/dist/js/bootstrap.bundle.min.js" integrity="sha384-YvpcrYf0tYfcbuBHvYlZYYt+zBC农btMCYZ3ONnBR47/Os+XE120OVV6hO1VPknHm" crossorigin="anonymous"></script>
  </body>
</html>
