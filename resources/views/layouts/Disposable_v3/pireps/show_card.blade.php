  ...
  <div class="card-header p-1">
    <h5 class="m-1">
      @if(filled($pirep->flight) && !str_contains($pirep->route_code, 'PF'))
        <a href="{{ route('frontend.flights.show', [$pirep->flight_id]) }}"><i class="bi bi-paper-plane mx-1" title="Flight Details"></i></a>
      @endif
  ...
  <div class="card-body p-1">
    <div class="row row-cols-md-3">
      <div class="col-md-5 text-start">
          <i class="bi bi-airplane-takeoff m-1"></i>
      ...
      <div class="col-md-5 text-end">
        ...
        <i class="bi bi-airplane-landing m-1"></i>
      </div>
    </div>
    <div class="row row-cols-md-3">
