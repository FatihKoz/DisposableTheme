...
<div class="row mb-1">
  ...
  <div class="col">
    <div class="card bg-transparent shadow-none text-dark border-0 mb-2">
      <div class="card-body bg-transparent p-0">
        <i class="bi bi-paper-plane-fill fa-3x float-end text-primary"></i>
  ...
  <div class="col">
    <div class="card bg-transparent shadow-none text-dark border-0 mb-2">
      <div class="card-body bg-transparent p-0">
        <i class="bi bi-clock-history fa-3x float-end text-danger"></i>
  ...
  @if($DBasic)
    <div class="col">
      <div class="card bg-transparent shadow-none text-dark border-0 mb-2">
      <div class="card-body bg-transparent p-0">
        <i class="bi bi-airport-fill fa-3x float-end text-success"></i>
    ...
    <div class="col">
      <div class="card bg-transparent shadow-none text-dark border-0 mb-2">
      <div class="card-body bg-transparent p-0">
        <i class="bi bi-pencil-square fa-3x float-end text-secondary"></i>
  ...
  <div class="col">
    <div class="card bg-transparent shadow-none text-dark border-0 mb-2">
      <div class="card-body bg-transparent p-0">
        <i class="bi bi-geo-alt-fill fa-3x float-end text-success"></i>
  ...
  <div class="col">
    <div class="card bg-transparent shadow-none text-dark border-0 mb-2">
      <div class="card-body bg-transparent p-0">
        <i class="bi bi-currency-dollar fa-3x float-end text-primary"></i>
