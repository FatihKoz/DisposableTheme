...
<div class="row row-cols-2 row-cols-md-4 row-cols-xl-8 mb-0">
  ...
  <div class="col-lg">
    <div class="card bg-transparent shadow-none text-dark border-0 mb-2">
      <div class="card-body bg-transparent p-0">
        <i class="bi bi-paper-plane fa-2x pt-1 float-end text-primary"></i>
  ...
  @if($DBasic)
    <div class="col-lg">
      <div class="card bg-transparent shadow-none text-dark border-0 mb-2">
      <div class="card-body bg-transparent p-0">
        <i class="bi bi-airport-fill fa-2x pt-1 float-end text-success"></i>
    ...
    <div class="col-lg">
      <div class="card bg-transparent shadow-none text-dark border-0 mb-2">
      <div class="card-body bg-transparent p-0">
        <i class="bi bi-pencil-square fa-2x pt-1 float-end text-secondary"></i>
    ...
    <div class="col-lg">
      <div class="card bg-transparent shadow-none text-dark border-0 mb-2">
      <div class="card-body bg-transparent p-0">
        <i class="bi bi-fuel-pump-diesel fa-2x pt-1 float-end text-info"></i>
  ...
  <div class="col-lg">
    <div class="card bg-transparent shadow-none text-dark border-0 mb-2">
      <div class="card-body bg-transparent p-0">
        <i class="bi bi-geo-alt fa-2x pt-1 float-end text-success"></i>
  ...
  <div class="col-lg">
    <div class="card bg-transparent shadow-none text-dark border-0 mb-2">
      <div class="card-body bg-transparent p-0">
        <i class="bi bi-currency-dollar fa-2x pt-1 float-end text-primary"></i>
