...
<span>
  <a href="https://github.com/FatihKoz" target="_blank" title="Version: v3.5.2 (26.NOV.23)">
    Disposable @if(isset($DSpecial) && $DSpecial) Extended Pack @elseif(isset($DBasic) && $DBasic) Basic Pack @else Theme @endif v3.5.x
  </a>
</span>
