...
<span>
  <a href="https://github.com/FatihKoz" target="_blank" title="Version: v3.3.1 (16.JUN.23)">
    Disposable @if(isset($DSpecial) && $DSpecial) Extended Pack @elseif(isset($DBasic) && $DBasic) Basic Pack @else Theme @endif v3.3.x
  </a>
</span>
