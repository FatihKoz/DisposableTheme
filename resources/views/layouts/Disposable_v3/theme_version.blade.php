...
<span>
  <a href="https://github.com/FatihKoz" target="_blank" title="Version: v3.0.ALPHA (14.NOV.21)">
    Disposable @if(isset($DSpecial) && $DSpecial) Extended Pack @elseif(isset($DBasic) && $DBasic) Basic Pack @else Theme @endif v3
  </a>
</span>
