...
<span>
  <a href="https://github.com/FatihKoz" target="_blank" title="Version: v3.4.1 (19.AUG.23)">
    Disposable @if(isset($DSpecial) && $DSpecial) Extended Pack @elseif(isset($DBasic) && $DBasic) Basic Pack @else Theme @endif v3.4.x
  </a>
</span>
